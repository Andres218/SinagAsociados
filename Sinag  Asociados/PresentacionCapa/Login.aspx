<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Login.aspx.vb" Inherits="PresentacionCapa.Login" %>
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" runat="server">
					...
					<div class="container-login100-form-btn">
					        ...
					        <asp:Label ID="MensajeError" runat="server" Text="Label"></asp:Label>
